...
Be sure to replace `<YOUR_METLO_API_KEY>` in the templates.
...
Here is an example
[metlo-daemonset.yaml](https://github.com/metlo-labs/metlo-deploy/blob/main/kubernetes/metlo-daemonset.yaml)
file that contains just the daemonset for deploying metlo.

### Sidecar

[metlo-sidecar.yaml](https://github.com/metlo-labs/metlo-deploy/blob/main/kubernetes/metlo-sidecar.yaml)
